...
| @commitlint/cli | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/config-conventional | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/config-validator | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/ensure | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/execute-rule | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/format | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/is-ignored | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/lint | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/load | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/message | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/parse | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/read | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/resolve-extends | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/rules | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/to-lines | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/top-level | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
| @commitlint/types | 18.4.3 | MIT | https://github.com/conventional-changelog/commitlint |
...
| @playwright/test | 1.40.0 | Apache-2.0 | https://github.com/microsoft/playwright |
| @remix-run/router | 1.13.0 | MIT | https://github.com/remix-run/react-router |
| @sinclair/typebox | 0.27.8 | MIT | https://github.com/sinclairzx81/typebox |
| @testing-library/dom | 9.3.3 | MIT | https://github.com/testing-library/dom-testing-library |
| @testing-library/jest-dom | 6.1.4 | MIT | https://github.com/testing-library/jest-dom |
| @testing-library/react | 14.1.2 | MIT | https://github.com/testing-library/react-testing-library |
...
| @types/chai-subset | 1.3.5 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
...
| @types/hoist-non-react-statics | 3.3.5 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @types/js-levenshtein | 1.1.3 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
...
| @types/prop-types | 15.7.10 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @types/react-dom | 18.2.17 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @types/react | 18.2.39 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @types/scheduler | 0.16.6 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
...
| @types/styled-components | 5.1.32 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @types/stylis | 4.2.3 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
| @typescript-eslint/eslint-plugin | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/parser | 6.13.1 | BSD-2-Clause | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/scope-manager | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/type-utils | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/types | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/typescript-estree | 6.13.1 | BSD-2-Clause | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/utils | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @typescript-eslint/visitor-keys | 6.13.1 | MIT | https://github.com/typescript-eslint/typescript-eslint |
| @ungap/structured-clone | 1.2.0 | ISC | https://github.com/ungap/structured-clone |
| @vitejs/plugin-react | 4.2.0 | MIT | https://github.com/vitejs/vite-plugin-react |
...
| acorn-walk | 8.3.0 | MIT | https://github.com/acornjs/acorn |
| acorn | 8.11.2 | MIT | https://github.com/acornjs/acorn |
| agent-base | 7.1.0 | MIT | https://github.com/TooTallNate/proxy-agents |
...
| caniuse-lite | 1.0.30001562 | CC-BY-4.0 | https://github.com/browserslist/caniuse-lite |
...
| cli-spinners | 2.9.1 | MIT | https://github.com/sindresorhus/cli-spinners |
...
| electron-to-chromium | 1.4.583 | ISC | https://github.com/kilian/electron-to-chromium |
| emoji-regex | 8.0.0 | MIT | https://github.com/mathiasbynens/emoji-regex |
| enquirer | 2.4.1 | MIT | https://github.com/enquirer/enquirer |
...
| fs-extra | 11.2.0 | MIT | https://github.com/jprichardson/node-fs-extra |
...
| http-proxy-agent | 7.0.0 | MIT | https://github.com/TooTallNate/proxy-agents |
| https-proxy-agent | 7.0.2 | MIT | https://github.com/TooTallNate/proxy-agents |
...
| inquirer | 8.2.6 | MIT | https://github.com/SBoudrias/Inquirer.js |
...
| jsdom | 23.0.0 | MIT | https://github.com/jsdom/jsdom |
...
| msw | 2.0.9 | MIT | https://github.com/mswjs/msw |
...
| playwright-core | 1.40.0 | Apache-2.0 | https://github.com/microsoft/playwright |
| playwright | 1.40.0 | Apache-2.0 | https://github.com/microsoft/playwright |
...
| react-router | 6.20.0 | MIT | https://github.com/remix-run/react-router |
...
| sort-by | 0.0.2 | MIT | https://github.com/staygrimm/sort-by |
...
| std-env | 3.5.0 | MIT | https://github.com/unjs/std-env |
...
| strip-literal | 1.3.0 | MIT | https://github.com/antfu/strip-literal |
| styled-components | 6.1.1 | MIT | https://github.com/styled-components/styled-components |
...
| tr46 | 5.0.0 | MIT | https://github.com/jsdom/tr46 |
...
| whatwg-url | 14.0.0 | MIT | https://github.com/jsdom/whatwg-url |
