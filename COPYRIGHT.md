...
| @commitlint/load | 17.4.4 | MIT | https://github.com/conventional-changelog/commitlint |
...
| @types/mdast | 3.0.11 | MIT | https://github.com/DefinitelyTyped/DefinitelyTyped |
...
| is-reference | 3.0.1 | MIT | https://github.com/Rich-Harris/is-reference |
...
| jest-diff | 29.4.3 | MIT | https://github.com/facebook/jest |
| jest-get-type | 29.4.3 | MIT | https://github.com/facebook/jest |
| jest-haste-map | 26.6.2 | MIT | https://github.com/facebook/jest |
| jest-matcher-utils | 29.4.3 | MIT | https://github.com/facebook/jest |
| jest-message-util | 29.4.3 | MIT | https://github.com/facebook/jest |
...
| jsdom | 21.1.0 | MIT | https://github.com/jsdom/jsdom |
...
| markdown-extensions | 1.1.1 | MIT | https://github.com/sindresorhus/markdown-extensions |
...
| mdast-util-from-markdown | 1.3.0 | MIT | https://github.com/syntax-tree/mdast-util-from-markdown |
| mdast-util-mdx-expression | 1.3.2 | MIT | https://github.com/syntax-tree/mdast-util-mdx-expression |
| mdast-util-mdx-jsx | 2.1.4 | MIT | https://github.com/syntax-tree/mdast-util-mdx-jsx |
| mdast-util-mdx | 2.0.1 | MIT | https://github.com/syntax-tree/mdast-util-mdx |
| mdast-util-mdxjs-esm | 1.3.1 | MIT | https://github.com/syntax-tree/mdast-util-mdxjs-esm |
| mdast-util-phrasing | 3.0.1 | MIT | https://github.com/syntax-tree/mdast-util-phrasing |
...
| mdast-util-to-markdown | 1.5.0 | MIT | https://github.com/syntax-tree/mdast-util-to-markdown |
...
| memfs | 3.5.1 | Unlicense | https://github.com/streamich/memfs |
...
| micromark-core-commonmark | 1.0.6 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-core-commonmark |
| micromark-extension-mdx-expression | 1.0.8 | MIT | https://github.com/micromark/micromark-extension-mdx-expression/tree/main/packages/micromark-extension-mdx-expression |
| micromark-extension-mdx-jsx | 1.0.5 | MIT | https://github.com/micromark/micromark-extension-mdx-jsx |
| micromark-extension-mdx-md | 1.0.1 | MIT | https://github.com/micromark/micromark-extension-mdx-md |
| micromark-extension-mdxjs-esm | 1.0.5 | MIT | https://github.com/micromark/micromark-extension-mdxjs-esm |
| micromark-extension-mdxjs | 1.0.1 | MIT | https://github.com/micromark/micromark-extension-mdxjs |
| micromark-factory-destination | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-factory-destination |
| micromark-factory-label | 1.0.2 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-factory-label |
| micromark-factory-mdx-expression | 1.0.9 | MIT | https://github.com/micromark/micromark-extension-mdx-expression/tree/main/packages/micromark-factory-mdx-expression |
| micromark-factory-space | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-factory-space |
| micromark-factory-title | 1.0.2 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-factory-title |
| micromark-factory-whitespace | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-factory-whitespace |
| micromark-util-character | 1.1.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-character |
| micromark-util-chunked | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-chunked |
| micromark-util-classify-character | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-classify-character |
| micromark-util-combine-extensions | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-combine-extensions |
| micromark-util-decode-numeric-character-reference | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-decode-numeric-character-reference |
| micromark-util-decode-string | 1.0.2 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-decode-string |
| micromark-util-encode | 1.0.1 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-encode |
| micromark-util-events-to-acorn | 1.2.3 | MIT | https://github.com/micromark/micromark-extension-mdx-expression/tree/main/packages/micromark-util-events-to-acorn |
| micromark-util-html-tag-name | 1.1.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-html-tag-name |
| micromark-util-normalize-identifier | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-normalize-identifier |
| micromark-util-resolve-all | 1.0.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-resolve-all |
| micromark-util-sanitize-uri | 1.1.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-sanitize-uri |
| micromark-util-subtokenize | 1.0.2 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-subtokenize |
| micromark-util-symbol | 1.0.1 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-symbol |
| micromark-util-types | 1.0.2 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark-util-types |
| micromark | 3.1.0 | MIT | https://github.com/micromark/micromark/tree/main/packages/micromark |
...
| minipass | 4.2.8 | ISC | https://github.com/isaacs/minipass |
...
| mlly | 1.1.1 | MIT | https://github.com/unjs/mlly |
...
| object.getownpropertydescriptors | 2.1.6 | MIT | https://github.com/es-shims/object.getownpropertydescriptors |
...
| parse-entities | 4.0.1 | MIT | https://github.com/wooorm/parse-entities |
...
| periscopic | 3.1.0 | MIT | https://github.com/Rich-Harris/periscopic |
...
| pretty-format | 29.4.3 | MIT | https://github.com/facebook/jest |
...
| property-information | 6.2.0 | MIT | https://github.com/wooorm/property-information |
...
| remark-mdx | 2.3.0 | MIT | https://github.com/mdx-js/mdx |
...
| schema-utils | 3.1.2 | MIT | https://github.com/webpack/schema-utils |
...
| std-env | 3.3.2 | MIT | https://github.com/unjs/std-env |
...
| stringify-entities | 4.0.3 | MIT | https://github.com/wooorm/stringify-entities |
...
| style-to-object | 0.4.1 | MIT | https://github.com/remarkablemark/style-to-object |
...
| tinybench | 2.4.0 | MIT | https://github.com/tinylibs/tinybench |
...
| ufo | 1.1.1 | MIT | https://github.com/unjs/ufo |
...
| unist-util-position-from-estree | 1.1.2 | MIT | https://github.com/syntax-tree/unist-util-position-from-estree |
...
| unist-util-remove-position | 4.0.2 | MIT | https://github.com/syntax-tree/unist-util-remove-position |
...
| ws | 8.12.1 | MIT | https://github.com/websockets/ws |
